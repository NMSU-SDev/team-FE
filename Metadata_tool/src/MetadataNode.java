 ...
 * @version 1.0
 * Invariant of the MetadataNode<M> class:
 *   1. Each node has one reference to an M Object, stored in the instance
 *      variable element.
 *   2. The instance variables child and sibling are references to the node's
...
public class MetadataNode <M> {
	...
	/**
	 * Initialize a <CODE>BTNode</CODE> with a specified initial element and links
	 ...
	 * @param - none
	 * @return
	 *   the question from this node as a String object
	 **/
	 ...
	 * @param - none
	 * @return
	 *   the answer from this node as a String object
	 **/
	 ...
	 * @param - none
	 * @return
	 *   the verified flag from this node as a boolean primative
	 **/
	 ...
	 * @param - none
	 * @return
	 *   a reference to the first child of this node (or the null reference if there
	 *   is no child)
	 **/
	...
	/**
	 * Accessor method to get the element from the youngest-child node of the tree below 
	 * this node.
	 * @param - none
	 * @return
	 ...
	 * @param - none
	 * <dt><b>Postcondition:</b><dd>
	 *   The tree starting at this node has had its youngest child node removed (i.e.,
	 *   the deepest node that can be reached by following child links). The
	 ...
	 * @param - none
	 * <dt><b>Postcondition:</b><dd>
	 *   The tree starting at this node has had its youngest sibling node removed (i.e.,
	 *   the deepest node that can be reached by following sibling links). The
	 *   return value is a reference to the root of the new (smaller) tree.
	 *   This return value could be null if the original tree had only one
	 *   node (since that one node has now been removed).
	 **/
	 ...
	 * <dt><b>Postcondition:</b><dd>
	 *   The question of this node has been set to <CODE>newQuestion</CODE>.
	 **/
	 ...
	 * <dt><b>Postcondition:</b><dd>
	 *   The answer of this node has been set to <CODE>newAnswer</CODE>.
	 **/
	 ...
	 * <dt><b>Postcondition:</b><dd>
	 *   The verified flag of this node has been set to <CODE>newVerified</CODE>.
	 **/
	 ...
	 *   a reference to the node that should appear as the first child of this node
	 *  (or the null reference if there is no child for this node)
	 * <dt><b>Postcondition:</b><dd>
	 *   The link to the first child of this node has been set to <CODE>newChild</CODE>.
	 ...
	 * @param <CODE>newLeft</CODE>
	 *   a reference to the node that should appear as the sibling of this node
	 *  (or the null reference if there is no sibling for this node)
	 * <dt><b>Postcondition:</b><dd>
	 *   The link to the sibling of this node has been set to <CODE>newSibling</CODE>.
	 ...
	 * <dt><b>Postcondition:</b><dd> 
	 * 	All leaves of the tree are printed.
	 * <dt><b>Note:</b><dd>
	 * 	Leaves are found left-right-root (post-order traversal)
	 */
